    ...
    <div class="shopcart">
      <div class="content">
        ...
        <div class="ball-container">
          <transition name="drop" @before-enter="beforeEnter" @enter="enter" @after-enter="afterEnter" v-for="(ball,ballIndex) in balls" :key="ballIndex">
        ...
        <transition name="fold">
          <div class="shopcart-list" v-show="listShow">
            ...
            <div class="list-content" ref="listContent">
              <ul>
                <li v-for="(food,foodIndex) in selectFoods" :key="foodIndex" class="food">
